...
basee[70]  = new MakeBasee("The Rift Bow"		,new GetKind(7,"Unique"),	 1,  1800,"Damage: 1 - 4    DUR:  30");
basee[71]  = new MakeBasee("The Needler"		,new GetKind(7,"Unique"),	 1,  8900,"Damage: 1 - 3    DUR:  30");
basee[72]  = new MakeBasee("The Celestial Bow"	,new GetKind(7,"Unique"),	 5,  1200,"Damage: 1 - 6    DUR:  35    Required:  DEX 30");
basee[73]  = new MakeBasee("Deadly Hunter"	,new GetKind(7,"Unique"),	 7,  8750,"Damage: 3 - 6    DUR:  45    Required:  STR 25  DEX 40");
basee[74]  = new MakeBasee("The Blackoak Bow"	,new GetKind(7,"Unique"),	 5,  2500,"Damage: 1 - 6    DUR:  35    Required:  STR 25  DEX 30");
basee[75]  = new MakeBasee("Bow of the Dead"	,new GetKind(7,"Unique"),	 7,  2500,"Damage: 3 - 6    DUR:  30    Required:  STR 25  DEX 40");
basee[76]  = new MakeBasee("Flamedart"		,new GetKind(7,"Unique"),	 3, 14250,"Damage: 2 - 5    DUR:  40    Required:  STR 20  DEX 35");
basee[77]  = new MakeBasee("Fleshstinger"		,new GetKind(7,"Unique"),	 5, 16500,"Damage: 1 - 6    DUR:  37    Required:  STR 25  DEX 30");
basee[78]  = new MakeBasee("Windforce"		,new GetKind(7,"Unique"),	19, 37750,"Damage: 1 -14    DUR:  60    Required:  STR 45  DEX 80");
basee[79]  = new MakeBasee("Eaglehorn"		,new GetKind(7,"Unique"),	11, 42500,"Damage: 1 -10    Indestructible    Required:  STR 30  DEX 60");

basee[80]  = new MakeBasee("The Defender"		,new GetKind(7,"Unique"),	 1,  2000,"Damage: 1 - 8    DUR:  45    Required:  STR 17");
basee[81]  = new MakeBasee("Gryphons Claw"	,new GetKind(7,"Unique"),	 2,  1000,"Damage: 4 - 8    DUR:  20    Required:  STR 30");
basee[82]  = new MakeBasee("Black Razor"		,new GetKind(7,"Unique"),	 1,  2000,"Damage: 1 - 4    DUR:   5");
basee[83]  = new MakeBasee("Gibbous Moon"		,new GetKind(7,"Unique"),	 8,  6660,"Damage: 4 -12    DUR:  50    Required:  STR 40");
basee[84]  = new MakeBasee("Ice Shank"		,new GetKind(7,"Unique"),	 6,  5250,"Damage: 2 -10    DUR:  15    Required:  STR 30");
basee[85]  = new MakeBasee("The Executioner's Blade",new GetKind(7,"Unique"),	 2,  7080,"Damage: 4 - 8    DUR:  60    Required:  STR 30");
basee[86]  = new MakeBasee("The Bonesaw"		,new GetKind(7,"Unique"),	 5,  4400,"Damage: 1 - 12    DUR:  36    Required:  STR 35");
basee[87]  = new MakeBasee("Shadowhawk"		,new GetKind(7,"Unique"),	 8, 13750,"Damage: 4 - 12    DUR:  50    Required:  STR 40");
basee[88]  = new MakeBasee("Wizardspike"		,new GetKind(7,"Unique"),	 1, 12920,"Damage: 1 - 4    DUR:  16");
basee[89]  = new MakeBasee("Lightsabre"		,new GetKind(7,"Unique"),	 1, 19150,"Damage: 1 - 8    DUR:  45    Required:  STR 17");
basee[90]  = new MakeBasee("The Falcon's Talon"	,new GetKind(7,"Unique"),	 4,  7867,"Damage: 3 - 7    DUR:  28    Required:  STR 23");
basee[91]  = new MakeBasee("Inferno"		,new GetKind(7,"Unique"),	 6, 34600,"Damage: 2 - 10    DUR:  40    Required:  STR 30");
basee[92]  = new MakeBasee("Doombringer"		,new GetKind(7,"Unique"),	10, 18250,"Damage: 6 - 15    DUR:  60    Required:  STR 50");

basee[93]  = new MakeBasee("The Grizzly"		,new GetKind(7,"Unique"),	14, 50000,"Damage: 8 - 16    DUR: 150    Required:  STR 65");
basee[94]  = new MakeBasee("The Grandfather"	,new GetKind(7,"Unique"),	17,119800,"Damage: 10 - 20    DUR: 100    Required:  STR 75");

basee[95]  = new MakeBasee("Sharp Beak"		,new GetKind(7,"Unique"),	 6,  2850,"Damage: 6 - 16    DUR:  40    Required:  STR 30");
basee[96]  = new MakeBasee("Bloodslayer"		,new GetKind(7,"Unique"),	 8,  2500,"Damage: 8 - 20    DUR:  50    Required:  STR 50");
basee[97]  = new MakeBasee("The Celestial Axe"	,new GetKind(7,"Unique"),	10, 14100,"Damage: 10 - 25    DUR:  60");
basee[98]  = new MakeBasee("Wicked Axe"		,new GetKind(7,"Unique"),	 6, 31150,"Damage: 6 - 16    Indestructible    Required:  STR 30");
basee[99]  = new MakeBasee("Stonecleaver"		,new GetKind(7,"Unique"),	 8, 23900,"Damage: 8 - 20    DUR:  50    Required:  STR 50");
basee[100] = new MakeBasee("Aguinara's Hatchet"	,new GetKind(7,"Unique"),	 2, 24800,"Damage: 2 - 10    DUR:  24");
basee[101] = new MakeBasee("Hellslayer"		,new GetKind(7,"Unique"),	10, 26200,"Damage: 10 - 25    DUR:  60    Required:  STR 65");
basee[102] = new MakeBasee("Messerschmidt's Reaver",new GetKind(7,"Unique"),	12, 58000,"Damage: 12 - 30    DUR:  75    Required:  STR 80");

basee[103] = new MakeBasee("Hammer of Jholm"	,new GetKind(7,"Unique"),	10,  8700,"Damage: 6 - 20    Indestructible    Required:  STR 55");
basee[104] = new MakeBasee("Civerb's Cudgel"	,new GetKind(7,"Unique"),	 2,  2000,"Damage: 1 - 8    DUR:  32    Required:  STR 16");
basee[105] = new MakeBasee("The Celestial Star"	,new GetKind(7,"Unique"),	 7,  7810,"Damage: 2 - 12    DUR:  36");
basee[106] = new MakeBasee("Baranar's Star"	,new GetKind(7,"Unique"),	 3,  6850,"Damage: 1 - 10    DUR:  60    Required:  STR 26");
basee[107] = new MakeBasee("Gnarled Root"		,new GetKind(7,"Unique"),	 1,  9820,"Damage: 1 - 6    DUR:  20");
basee[108] = new MakeBasee("Gnarled Root"		,new GetKind(7,"Unique"),	 4,  9820,"Damage: 3 - 6    DUR:  20    Required:  STR 18");
basee[109] = new MakeBasee("The Cranium Basher"	,new GetKind(7,"Unique"),	10, 36500,"Damage: 6 - 20    Indestructible    Required:  STR 55");
basee[110] = new MakeBasee("Schaefer's Hammer"	,new GetKind(7,"Unique"),	 5, 56125,"Damage: 5 - 9    DUR:  50    Required:  STR 40");
basee[111] = new MakeBasee("Dreamflange"		,new GetKind(7,"Unique"),	 2, 26450,"Damage: 1 - 8    DUR:  32    Required:  STR 16");

basee[112] = new MakeBasee("Staff of Shadows"	,new GetKind(7,"Unique"),	 4,  1250,"Damage: 4 - 8    DUR:  35");
basee[113] = new MakeBasee("Immolator"		,new GetKind(7,"Unique"),	 4,  3900,"Damage: 4 - 8    DUR:  35");
basee[114] = new MakeBasee("Storm Spire"		,new GetKind(7,"Unique"),	12, 22500,"Damage: 8 - 16    DUR:  75    Required:  STR 30");
basee[115] = new MakeBasee("Gleamsong"		,new GetKind(7,"Unique"),	 1,  6250,"Damage: 2 - 4    DUR:  25");
basee[116] = new MakeBasee("Thundercall"		,new GetKind(7,"Unique"),	 6, 22250,"Damage: 5 - 10    DUR:  45");
basee[117] = new MakeBasee("The Protector"	,new GetKind(7,"Unique"),	 1, 17240,"Damage: 2 - 4    DUR:  25");
basee[118] = new MakeBasee("Naj's Puzzler"	,new GetKind(7,"Unique"),	 4, 34000,"Damage: 4 - 8    DUR:  35");
basee[119] = new MakeBasee("Mindcry"		,new GetKind(7,"Unique"),	 9, 41500,"Damage: 6 - 12    DUR:  55    Required:  STR 20");
basee[120] = new MakeBasee("Rod of Onan"		,new GetKind(7,"Unique"),	12, 44167,"Damage: 8 - 16    DUR:  75    Required:  STR 30");

basee[121] = new MakeBasee("Helm of Sprits"	,new GetKind(7,"Unique"),	 8,  7525,"Armor Class: 4 - 6    DUR:  30    Required:  STR 25");
basee[122] = new MakeBasee("Thinking Cap"		,new GetKind(7,"Unique"),	 4,  2020,"Armor Class: 2 - 4    DUR:   1");
basee[123] = new MakeBasee("Overlord's Helm"	,new GetKind(7,"Unique"),	 8, 12500,"Armor Class: 4 - 6    DUR:  15    Required:  STR 25");
basee[124] = new MakeBasee("Fool's Crest"		,new GetKind(7,"Unique"),	 8, 10150,"Armor Class: 4 - 6    DUR:  30    Required:  STR 25");
basee[125] = new MakeBasee("Gotterdamerung"	,new GetKind(7,"Unique"),	20, 54900,"Armor Class: 60        DUR:  60    Required:  STR 50");
basee[126] = new MakeBasee("Royal Circlet"	,new GetKind(7,"Unique"),	16, 24875,"Armor Class: 40        DUR:  40");

basee[127] = new MakeBasee("Torn Flesh of Souls"	,new GetKind(7,"Unique"),	 1,  4825,"Armor Class: 8        Indestructible");
basee[128] = new MakeBasee("The Rainbow Cloak"	,new GetKind(7,"Unique"),	 2,  4900,"Armor Class: 10        DUR:  27");
basee[129] = new MakeBasee("Leather of Aut"	,new GetKind(7,"Unique"),	 6, 10550,"Armor Class: 15        Indestructible");
basee[130] = new MakeBasee("Wisdom's Wrap"	,new GetKind(7,"Unique"),	 3,  6200,"Armor Class: 15        DUR:  24");
basee[131] = new MakeBasee("The Gladiator's Bane"	,new GetKind(7,"Unique"),	 9,  3450,"Armor Class: 25        DUR: 135    Required:  STR 20");
basee[132] = new MakeBasee("Sparking Mail"	,new GetKind(7,"Unique"),	13, 15750,"Armor Class: 30        DUR:  55    Required:  STR 30");
basee[133] = new MakeBasee("Scavenger Carapace"	,new GetKind(7,"Unique"),	16, 14000,"Armor Class: -10 - -6    DUR:  80    Required:  STR 40");
basee[134] = new MakeBasee("Nightscape"		,new GetKind(7,"Unique"),	 1, 11600,"Armor Class: 15        DUR:  12");
basee[135] = new MakeBasee("Naj's Light Plate"	,new GetKind(7,"Unique"),	19, 78700,"Armor Class: 42 - 50    DUR:  75");
basee[136] = new MakeBasee("Demonspike Coat"	,new GetKind(7,"Unique"),	25,251175,"Armor Class: 100        Indestructible    Required:  STR 90");

basee[137] = new MakeBasee("Split Skull Shield"	,new GetKind(7,"Unique"),	 1,  2025,"Armor Class: 10        DUR:  15");
basee[138] = new MakeBasee("Dragon's Breach"	,new GetKind(7,"Unique"),	14, 19200,"Armor Class: 20        Indestructible    Required:  STR 50");
basee[139] = new MakeBasee("Blackoak Shield"	,new GetKind(7,"Unique"),	 5,  5725,"Armor Class: 18        DUR:  60    Required:  STR 25");
basee[140] = new MakeBasee("Holy Defender"	,new GetKind(7,"Unique"),	 9, 13800,"Armor Class: 15        DUR:  96    Required:  STR 40");
basee[141] = new MakeBasee("Stormshield"		,new GetKind(7,"Unique"),	20, 49000,"Armor Class: 40        Indestructible    Required:  STR 60");
basee[142] = new MakeBasee("Stormshield"		,new GetKind(7,"Unique"),	23, 49000,"Armor Class: 40        Indestructible    Required:  STR 80");

basee[143] = new MakeBasee("Ring of Regha"	,new GetKind(7,"Unique"),	 5,  4175,"Indestructible");
basee[144] = new MakeBasee("The Bleeder"		,new GetKind(7,"Unique"),	 5,  8500,"Indestructible");
basee[145] = new MakeBasee("Constricting Ring"	,new GetKind(7,"Unique"),	 5, 62000,"Indestructible");
basee[146] = new MakeBasee("Ring of Engagement"	,new GetKind(7,"Unique"),	 5, 12476,"Indestructible");


//-- UNIQUE ITEM DATA ------

uniq[0]  = new MakeUniq("Short Bow",1,1,	"Fires Random Speed Arrows   Add 2 Points Damage   -3 to Dexterity");
uniq[1]  = new MakeUniq("Short Bow",2,60,	"Chance to Hit +50%   Unusual Item Damage   Fast Attack");
uniq[2]  = new MakeUniq("Long Bow",2,4,		"No Strength Requirement   Add 2 Points Damage   Armor Class: 5");
uniq[3]  = new MakeUniq("Composite Bow",3,4,	"+200% Damage vs. Demons   Chance to Hit +20%   -5 to Magic");
uniq[4]  = new MakeUniq("Long Bow",5,12,	"+10 to Dexterity   -10 to Vitality   Damage: +50%\n    -10% Light Radius");
uniq[5]  = new MakeUniq("Composite Bow",5,60,	"Chance to Hit +10%   +4 to Dexterity   -3 to Vitality\n    -20% Light Radius   Alterd Durability");
uniq[6]  = new MakeUniq("Hunter's Bow",10,60,	"Fire Arrows Damage: 1-6   Fire Hit Damage: 1-6   Chance to Hit +20%\n    Resist Fire +40%");
uniq[7]  = new MakeUniq("Long Bow",13,60,	"+15 to Dexterity   Chance to Hit +40%   Damage: +80%\n    High Durability");
uniq[8]  = new MakeUniq("Long War Bow",17,60,	"+5 to Strength   Damage: +200%   Knocks Target Back");
uniq[9]  = new MakeUniq("Long Battle Bow",26,60,"+20 to Dexterity   Chance to Hit +50%   Damage: +100%\n    Indestructible");

uniq[10] = new MakeUniq("Sabre",1,12,		"Armor Class: 5   +5 to Vitality   Chance to Hit -5%");
uniq[11] = new MakeUniq("Falchion",1,2,		"Damage: +100%   -2 to Magic   -5 to Dexterity");
uniq[12] = new MakeUniq("Dagger",1,10,		"Damage: +150%   +2 to Vitality   Alterd Durability");
uniq[13] = new MakeUniq("Broad Sword",2,7,	"+2 to All Attributes   Damage: +25%   MANA +15\n    -30% Light Radius");
uniq[14] = new MakeUniq("Long Sword",3,16,	"Resist Fire +40%   Alterd Durability   +5-10 to Strength");
uniq[15] = new MakeUniq("Falchion",3,60,	"Damage: +150%   Hit Points -10   -10% Light Radius\n    High Durability");
uniq[16] = new MakeUniq("Claymore",6,60,	"Add 10 Points Damage   +10 to Strength   -5 to Magic\n    -5 to Dexterity   Hit Points +10   MANA -10");
uniq[17] = new MakeUniq("Broad Sword",8,60,	"-20% Light Radius   Hit Steals 5% LIFE   Chance to Hit +15%\n    Resist All +5%");
uniq[18] = new MakeUniq("Dagger",11,60,		"+15 to Magic   MANA +35   Chance to Hit +25%\n    Resist All +15%");
uniq[19] = new MakeUniq("Sabre",13,60,		"+20% Light Radius   Lightning Hit Damage: 1-10   Chance to Hit +20%\n    Resist Lightning +50%");
uniq[20] = new MakeUniq("Schimitar",15,60,	"Fastest Attack   Chance to Hit +20%   Damage: -33%\n    +10 to Dexterity");
uniq[21] = new MakeUniq("Long Sword",17,60,	"Fire Hit Damage: 2-12   +30% Light Radius   MANA +20\n    Resist Fire 75% MAX");
uniq[22] = new MakeUniq("Bastard Sword",19,60,	"Chance to Hit +25%   Damage: +250%   -5 to All Attributes\n    Hit Points -25   -20% Light Radius");

uniq[23] = new MakeUniq("Two-Handed Sword",23,60,"+20 to Strength   -5 to Vitality   Damage: +200%\n    Knocks Target Back   High Durability");
uniq[24] = new MakeUniq("Great Sword",27,60,	"One Handed Sword   +5 to All Attributes   Chance to Hit +20%\n    Damage: +70%   Hit Points +20");

uniq[25] = new MakeUniq("Large Axe",2,4,	"Hit Points +20   -10 to Magic   MANA -10");
uniq[26] = new MakeUniq("Broad Axe",3,6,	"Damage: +100%   +200% Damage vs. Demons   -5 to All Attributes\n    Spells Are Decreased 1 Level");
uniq[27] = new MakeUniq("Battle Axe",4,14,	"No Strength Requirement\n    Chance to Hit +15%   Hit Points +15   -15 to Strength");
uniq[28] = new MakeUniq("Large Axe",5,60,	"Chance to Hit +30%   +10 to Dexterity   -10 to Vitality\n    -1--6 Damage from Enemy   Indestructible");
uniq[29] = new MakeUniq("Broad Axe",7,60,	"Hit Points +30   Chance to Hit +20%   Damage: +50%\n    Resist Lightning +40%");
uniq[30] = new MakeUniq("Small Axe",12,60,	"Spells Are Increased 1 Level   +10 to Magic   Resist Magic 75% MAX");
uniq[31] = new MakeUniq("Battle Axe",15,60,	"+8 to Strength   +8 to Vitality   Damage: +100%\n    Hit Points +25   MANA -25");
uniq[32] = new MakeUniq("Great Axe",25,60,	"Damage: +200%   Add 15 Points Damage   +5 to All Attributes\n    Hit Points -50   Fire Hit Damage: 2-12");

uniq[33] = new MakeUniq("Maul",1,11,		"Damage: +4-10%   Indestructible   +3 to Strength\n    Chance to Hit +15%");
uniq[34] = new MakeUniq("Mace",1,25,		"+200% Damage vs. Demons   -5 to Dexterity   -2 to Magic");
uniq[35] = new MakeUniq("Flail",2,60,		"No Strength Requirement\n    +20% Light Radius   Add 10 Points to Damage   Armor Class: -8");
uniq[36] = new MakeUniq("Morning Star",5,60,	"Chance to Hit +12%   Damage: +80%   Quick Attack\n    +4 to Vitality   -4 to Dexterity   High Durability");
uniq[37] = new MakeUniq("Club",9,60,		"Chance to Hit +20%   Damage: +300%   +10 to Dexterity\n    +5 to Magic   Resist All +10%   Armor Class: -10");
uniq[38] = new MakeUniq("Spiked Club",9,60,	"Chance to Hit +20%   Damage: +300%   +10 to Dexterity\n    +5 to Magic   Resist All +10%   Armor Class: -10");
uniq[39] = new MakeUniq("Maul",12,60,		"Add 20 Points Damage   +15 to Strength   Indestructible\n    MANA -150   Resist All +5%");
uniq[40] = new MakeUniq("War Hammer",16,60,	"Damage: -100%   Lightning Hit Damage: 1-50   Hit Points +50\n    Chance to Hit +30%   Resist Lightning 75% MAX   +10% Light Radius");
uniq[41] = new MakeUniq("Mace",26,60,		"+30 to Magic   MANA +50   Resist Magic +50%\n    +20% Light Radius   Spells Are Increased 1 Level");

uniq[42] = new MakeUniq("Long Staff",2,3,	"-10 to Magic   Chance to Hit +10%   Damage: +60%\n    -20% Light Radius   Quick Attack");
uniq[43] = new MakeUniq("Long Staff",4,17,	"Resist Fire +20%   Fire Hit Damage: 4 - 4   MANA +10\n    -5 to Vitality");
uniq[44] = new MakeUniq("War Staff",8,21,	"Resist Lightning +50%   Lightning Hit Damage: 2-8   +10 to Strength\n    -10 to Magic");
uniq[45] = new MakeUniq("Short Staff",8,15,	"MANA +25   -3 to Strength   -3 to Vitality\n    Charges 76 Phasing");
uniq[46] = new MakeUniq("Composite Staff",14,60,"Chance to Hit +35%   Lightning Hit Damage: 1-10   Charges 76 Lightning\n    Resist Lightning +30%   +20% Light Radius");
uniq[47] = new MakeUniq("Short Staff",16,60,	"+5 to Vitality   -5 Damage from Enemy   Armor Class: 40\n    Charges 86 Healing   Attacker Takes 1-3 Damage");
uniq[48] = new MakeUniq("Long Staff",18,60,	"+20 to Magic   +10 to Dexterity   Resist All +20%\n    Charges 57 Teleport   Hit Points -25");
uniq[49] = new MakeUniq("Quarter Staff",20,60,	"+15 to Magic   Charges 69 Guardian   Resist All +15%\n    Spells Are Increased 1 Level");
uniq[50] = new MakeUniq("War Staff",22,60,	"Charges 50 Golem   Damage: +100%   +5 to All Attributes");

uniq[51] = new MakeUniq("Helm",1,6,		"Hit Steals 5% Life");
uniq[52] = new MakeUniq("Skull Cap",6,60,	"MANA +30   Spells Are Increased 2 Levels   Resist All +20%\n    Alterd Durability");
uniq[53] = new MakeUniq("Helm",7,11,		"+20 to Strength   +15 to Dexterity   +5 to Vitality\n    -20 to Magic   Alterd Durability");
uniq[54] = new MakeUniq("Helm",12,60,		"-4 to All Attributes   Hit Points +100   +1-6 Damage from Enemy\n    Attacker Takes 1-3 Damage");
uniq[55] = new MakeUniq("Great Helm",21,60,	"+20 to All Attributes   Armor Class: 60   -4 Damage from Enemy\n    All Resistance Equals 0   -40% Light Radius");
uniq[56] = new MakeUniq("Crown",27,60,		"+10 to All Attributes   MANA +40   Armor Class: 40\n    +10% Light Radius");

uniq[57] = new MakeUniq("Rags",2,60,		"Armor Class: 8   +10 to Vitality   -1 Damage from Enemy\n    Indestructible");
uniq[58] = new MakeUniq("Cloak",2,60,		"Armor Class: 10   +1 to All Attributes   Resist All +10%\n    Hit Points +5   High Durability");
uniq[59] = new MakeUniq("Leather Armor",4,60,	"Armor Class: 15   +5 to Strength   -5 to Magic\n    +5 to Dexterity   Indestructible");
uniq[60] = new MakeUniq("Robe",5,60,		"+5 to Magic    MANA +10   Resist Lightning +25%\n    Armor Class: 15   -1 Damage from Enemy");
uniq[61] = new MakeUniq("Studded Leather Armor",6,60,"Armor Class: 25   -2 Damage from Enemy   High Durability\n    -3 to All Attributes");
uniq[62] = new MakeUniq("Chain Mail",9,60,	"Armor Class: 30   Lightning Hit Damage: 1-10");
uniq[63] = new MakeUniq("Breast Plate",13,60,	"-15 Damage from Enemy   Armor Class: -30   +5 to Dexterity\n    Resist Lightning +40%");
uniq[64] = new MakeUniq("Cape",16,60,		"Faster Hit Recovery   -40% Light Radius   Armor Class: 15\n    +3 to Dexterity   Resist All +20%");
uniq[65] = new MakeUniq("Plate Mail",19,60,	"No Strength Requirement   +5 to Magic   MANA +20\n    Resist All +20%   Spells Are Increased 1 Level");
uniq[66] = new MakeUniq("Full Plate Mail",25,60,"Armor Class: 100   -6 Damage from Enemy   +10 to Strength\n    Indestructible   Resist Fire +50%");

uniq[67] = new MakeUniq("Buckler",1,60,		"Armor Class: 10   Hit Points +10   +2 to Strength\n    -10% Light Radius   Alterd Durability");
uniq[68] = new MakeUniq("Kite Shield",2,60,	"Resist Fire +25%   +5 to Strength   Armor Class: 20\n    -5 to Magic   Indestructible");
uniq[69] = new MakeUniq("Small Shield",4,60,	"+10 to Dexterity   -10 to Vitality   Armor Class: 18\n    -10% Light Radius   High Durability");
uniq[70] = new MakeUniq("Large Shield",10,60,	"Armor Class: 15   -2 Damage from Enemy   Resist Fire +20%\n    High Durability   Fast Block");
uniq[71] = new MakeUniq("Tower Shield",24,60,	"Armor Class: 40   +4 Damage from Enemy   +10 to Strength\n    Indestructible   Fast Block");
uniq[72] = new MakeUniq("Gothic Shield",24,60,	"Armor Class: 40   +4 Damage from Enemy   +10 to Strength\n    Indestructible   Fast Block");

uniq[73] = new MakeUniq("Ring",1,1,		"+10 to Magic   Resist Magic +10%   +10 Light Radius\n    -3 to Strength   -3 to Dexterity");
uniq[74] = new MakeUniq("Ring",2,4,		"Resist Magic +20%   MANA +30   Hit Points -10");
uniq[75] = new MakeUniq("Ring",5,10,		"Resist All 75% MAX   Constantly Lose Hit Points");
uniq[76] = new MakeUniq("Ring",11,60,		"-1--2 Damage from Enemy   Attacker Takes 1-3 Damage   Armor Class: 5\n    Damages Target's Armor(4-12)");
